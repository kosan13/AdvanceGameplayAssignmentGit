...
namespace Game
{
    public partial class BlobDivisionMaze
    {
        ...
        private void StartFloodFill()
        {
            ...
            foreach (var VARIABLE in gWalls)
            {
            ...
            foreach (HashSet<(Tile, Tile)> wallList in gWalls)
            {
                ...
                { 
                    ...
                    Transform temp = Instantiate(wall.Item1.Visual);
                    position.y += 8.2f;
        ...
        private static (HashSet<Tile>, HashSet<Tile>) FloodFill((Tile, Tile) start)
        {
            ...
            {
                NeighborsSearchData searchData1 = new (open.Item1, closed.Item1, closed.Item2, open, closed);
                NeighborsSearchData searchData2 = new (open.Item2, closed.Item2, closed.Item1, open, closed);
                if (flipper)
                {
        ...
        private void RecursiveFloodFill(RecursiveFloodFillData recursiveFloodFillData)
        {
            ...
            newRecursiveFloodFillData.Item1 = NewRecursiveFloodFillData(recursiveFloodFillData, recursiveFloodFillData.RecursiveItems.Item1);
            newRecursiveFloodFillData.Item2 = NewRecursiveFloodFillData(recursiveFloodFillData, recursiveFloodFillData.RecursiveItems.Item2);
        ...
        private static RecursiveFloodFillData NewRecursiveFloodFillData(RecursiveFloodFillData data, HashSet<TileSystem.Tile> recursiveItems)
        {
            ...
            (HashSet<Tile>, HashSet<Tile>) newRecursiveItems = FloodFill(ResetTilesAndGetSeedTile(recursiveItems, _tileMap));
